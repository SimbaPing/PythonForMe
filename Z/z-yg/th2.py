...
wsaja = list(range(wsaj - 5, wsaj + 5))
wsaka = list(range(wsak - 5, wsak + 5))
wsbja = list(range(wsbj - 5, wsbj + 5))
...
for i in range(0, ttt):
    ...
    h15.sort()
    booksheet.write(m, 11, abs(kth - h15[0]))
...
for i in range(0, ttt):
    ...
    h34.sort()
    booksheet.write(m1, 14, h34[1] - h34[0])
    m1 += 6
